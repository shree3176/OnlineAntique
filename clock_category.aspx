<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="clock_category.aspx.cs" Inherits="clock_category" Title="::Antique Clock::" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script src="category/c_cate.js" type="text/javascript"></script>
...
<div id="sitemap"> <a href="home.aspx">Home  ---></a><a href="clock_category.aspx">Clock</a></div>
<h1>Antique Clocks</h1>
 <%--<div id="free-download" class="modal-box wrapper"><div class="inside green">
		<span class="modal-close"><span>Close</span></span>
     <img src="zoom/images/antique_clock/806gldwtch9.1L.jpg" width="150px" height="150px"/>
		<b>Price:-</b>$300
	...
	<div id="mailing-list" class="modal-box wrapper"><div class="inside blue">
        ...
        <img src="zoom/images/antique_clock/B565.1L.jpg" width="150px" height="150px"/>
		<b>Price:-</b>$240
		<p>Hey there, fancy a super awesome download? Go on, it's on us!</p>
	...
	<span class="modal-close"><span>Close</span></span>
        <img src="zoom/images/antique_clock/CA16583.1L.jpg" width="150px" height="150px"/>
		<b>Price:-</b>$250
		<p>Hey there, fancy a super awesome download? Go on, it's on us!</p>
	...
	<div id="heart-favorites" class="modal-box wrapper"><div class="inside red">
		<span class="modal-close"><span>Close</span></span>
        <img src="zoom/images/antique_clock/e-00503.1L.jpg" width="150px" height="150px" />
		<b>Price:-</b>$200
		<p>Hey there, fancy a super awesome download? Go on, it's on us!</p>
	...
	<div id="star-favorites" class="modal-box wrapper"><div class="inside yellow">
		<span class="modal-close"><span>Close</span></span>
        <img src="zoom/images/antique_clock/GCR-114.1L.jpg" width="150px" height="150px" />
		<b>Price:-</b>$400
		<p>Hey there, fancy a super awesome download? Go on, it's on us!</p>
	...
	<div id="adjust-settings" class="modal-box wrapper"><div class="inside grey">
		<span class="modal-close"><span>Close</span></span>
        <img src="zoom/images/antique_clock/gy-001102.1L.jpg" width="150px" height="150px"/>
		<b>Price:-</b>$500
		<p>Hey there, fancy a super awesome download? Go on, it's on us!</p>
	</div></div>
	...
	<span class="modal-close"><span>Close</span></span>
        <img src="zoom/images/antique_clock/gy-001417.1L.jpg" width="150px" height="150px"/>
		<b>Price:-</b>$235
		<p>Hey there, fancy a super awesome download? Go on, it's on us!</p>
	...
	<span class="modal-close"><span>Close</span></span>
        <img src="zoom/images/antique_clock/ME-0018.1L.jpg" width="150px" height="150px"/>
		<b>Price:-</b>$250
		<p>Hey there, fancy a super awesome download? Go on, it's on us!</p>
...
<table width="70%" align="center" cellpadding="0px" cellspacing="0px">
		...
		<tr>
			<td width="10%" align="center" id="antique0"><%--<span rel="#free-download" class="modal-link"><span>--%>14K Gold Pocket Watch<br />
			...
			<td width="10%" align="center" id="antique1"><%--<span rel="#mailing-list" class="modal-link">--%>Thomas 2 Faced Clock<br />
			...
			<td width="10%" align="center" id="antique2"><%--<span rel="#restricted-content" class="modal-link"><span>--%>Sevres Clock Set<br />
			...
			<td width="10%"><img src="category/rm.jpg" height="100" onMouseOver="javscript:showAntique(5)"/></td>
				...
				<tr>
			<td width="10%" align="center" id="antique3"><span rel="#heart-favorites" class="modal-link"><span>Antique Pocket Watch<br />
			...
			<td width="10%" align="center" id="antique4"><span rel="#star-favorites" class="modal-link"><span>Antique Clock Face<br />
			...
			<td width="10%" align="center" id="antique5"><span rel="#adjust-settings" class="modal-link"><span>Brass Ships Bell Clock<br />
		...
		<tr>
			<td width="10%" align="center" id="antique6"><span rel="#warning" class="modal-link"><span>Green chiming Clock<br />
			...
			<td width="10%" align="center" id="antique7"><span rel="#stop" class="modal-link"><span>Rolex Watch Retro styling<br />
			...
			<td width="10%" align="center" id="antique8">Marble Bronze Mantel Clock<br />
		...
		<tr>
			<td width="10%" align="center" id="antique9">French Tiffany &amp; Co Clock<br />
			...
			<td width="10%" align="center" id="antique10">gold fill woman pocket watch<br />
			...
			<td width="10%" align="center" id="antique11">Bronze Mantle Clock<br />
